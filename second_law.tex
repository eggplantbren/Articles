...
but in physics it can be bigger by a factor of something like $10^{23}$. Therefore, the following rule of thumb is at least
...
The second law of thermodynamics is as simple as that. Understanding the
logic of this, and how it arises from uncertain reasoning,
is the key to extending its use outside of physics.
