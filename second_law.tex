...
(it's a property not of the arrow in the previous figure, but a
property of the red and green regions we drew around it).
...
All these specific conditions must be met in order to sing a high note. And
...
most of them don't lead to a successful good-sounding note (/an accurate
golf shot).
